...
const SOLUTIONS = [
  ...
  },
  {
    id: "05-railway",
    name: "Railway",
    path: "solutions/05-railway",
    script: "dashboard-app.js",
  },
  {
    id: "06-agentic_rag",
    name: "Agentic RAG",
    path: "solutions/06-agentic_rag",
    script: "dashboard-app.js",
  },
  {
    id: "06-categorize",
    name: "Categorize",
    path: "solutions/06-categorize",
    script: "dashboard-app.js",
  },
  {
    id: "07-electricity",
    name: "Electricity",
    path: "solutions/07-electricity",
    script: "dashboard-app.js",
  },
  {
    id: "08-failure",
    name: "Failure",
    path: "solutions/08-failure",
    script: "dashboard-app.js",
  },
  {
    id: "09-mailbox",
    name: "Mailbox",
    path: "solutions/09-mailbox",
    script: "dashboard-app.js",
  },
  {
    id: "10-drone",
    name: "Drone",
    path: "solutions/10-drone",
    script: "dashboard-app.js",
  },
